...
android {
    namespace = "com.abelgarciavicario.deliverypedimos"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.abelgarciavicario.deliverypedimos"
        minSdk = 28
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("androidx.compose.material:material-icons-extended:1.5.4")   //Iconos
